...
export const ExtendedThemeProvider = ({ children }: { children: ReactNode }) => {
	...
	const effectiveScheme: "light" | "dark" = selected === "system" ? (deviceScheme === "dark" ? "dark" : "light") : selected;
	const theme = effectiveScheme === "light" ? LightCustomTheme : DarkCustomTheme;

	const contextValue = useMemo(() => ({ scheme: effectiveScheme, theme }), [effectiveScheme, theme]);
