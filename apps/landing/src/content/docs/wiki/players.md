...
1. Join the server in Minecraft.
2. Run the in-game pairing command (details land here once M2 ships).
3. Enter the code shown in-game into the app.

You'll only ever see and control devices you own, or devices shared with a group you're a member of.
